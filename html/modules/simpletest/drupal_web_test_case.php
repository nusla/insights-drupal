...
abstract class DrupalTestCase {
	...
	protected function assert($status, $message = '', $group = 'Other', array $caller = NULL) {
		...
		self::getDatabaseConnection ()->insert ( 'simpletest' )->fields ( $assertion )->execute ();
	 ...
	 *
	 * @return DatabaseConnection The database connection to use for inserting assertions.
	 */
	...
	public static function insertAssert($test_id, $test_class, $status, $message = '', $group = 'Other', array $caller = array()) {
		...
		return self::getDatabaseConnection ()->insert ( 'simpletest' )->fields ( $assertion )->execute ();
	}
	...
	public static function deleteAssert($message_id) {
		return ( bool ) self::getDatabaseConnection ()->delete ( 'simpletest' )->condition ( 'message_id', $message_id )->execute ();
	}
...
class DrupalWebTestCase extends DrupalTestCase {
	 ...
	 *        	
	 * @return object|false A fully loaded user object with pass_raw property, or FALSE if account
	 *         creation fails.
	 */
	 ...
	 * @param $index Link
	 *        	position counting from zero.
	 * @return Page contents on success, or FALSE on failure.
	 */
	 ...
	 *        	Value of the field to assert. You may pass in NULL (default)
	 ...
	 *        	used to find the field.
	 * @param $value (optional)
	 *        	Value for the field, to assert that the field's value on the
	 ...
	 *        	of field to assert.
	 * @param $value (optional)
	 *        	Value for the field to assert. You may pass in NULL to skip
