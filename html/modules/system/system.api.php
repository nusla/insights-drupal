 ...
 *        	
 * @throws DrupalUpdateException|PDOException In case of error, update hooks should throw an instance of DrupalUpdateException
 *         with a meaningful message for the user. If a database query fails for whatever
 *         reason, it will throw a PDOException.
 *        
 * @return string|null Optionally, update hooks may return a translated string that will be
