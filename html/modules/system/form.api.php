 ...
 *
 * @param $MULTIPLE_PARAMS Additional
 *        	parameters specific to the batch. These are specified in the
 *        	array passed to batch_set().
 * @param $context The
 *        	batch context array, passed by reference. This contains the following
 *        	properties:
 ...
 *
 * @param $success A
 *        	boolean indicating whether the batch has completed successfully.
 * @param $results The
 *        	value set in $context['results'] by callback_batch_operation().
 * @param $operations If
 *        	$success is FALSE, contains the operations that remained unprocessed.
 */
