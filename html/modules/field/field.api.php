 ...
 *        	
 * @see hook_field_extra_fields() @ingroup field_types
 */
 ...
 * @param $entity The
 *        	entity with fields to validate.
 * @param array $errors
 ...
 *        	type of entity; for example, 'node' or 'user'.
 * @param $bundle The
 *        	name of the bundle that was just deleted.
 * @param $instances An
 ...
 *        	- instance: The instance of the field.
 *        	
 * @see hook_field_widget_properties_alter() @ingroup field_widget
 */
