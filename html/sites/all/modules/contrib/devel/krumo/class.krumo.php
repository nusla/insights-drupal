...
/**
 * Set the KRUMO_DIR constant up with the absolute path to Krumo files.
 * If it is
 ...
 * as they are.
 * Longer strings will be truncated with this length, and
...
class krumo {
	...
	Public Static Function classes() {
		...
		//
		?>
<div class="krumo-title">This is a list of all currently declared
	classes.</div>
<?php
...
<?php
	...
	Public Static Function includes() {
		...
		//
		?>
<div class="krumo-title">This is a list of all currently included (or
	required) files.</div>
<?php
...
<?php
	...
	Public Static Function extensions() {
		...
		//
		?>
<div class="krumo-title">This is a list of all currently loaded PHP
	extensions.</div>
<?php
	...
	Public Static Function headers() {
		...
		//
		?>
<div class="krumo-title">This is a list of all HTTP request headers.</div>
<?php
...
<div class="krumo-title">
	...
	<code>
		<b><?php echo get_cfg_var('cfg_file_path');?></b>
	</code>
	.
</div>
<?php
	...
	Public Static Function conf() {
		...
		//
		?>
<div class="krumo-title">This is a list of all your configuration
	settings.</div>
<?php
	...
	Public Static Function path() {
		...
		?>
<div class="krumo-title">
	This is a list of the specified directories under your
	<code>
		<b>include_path</b>
	</code>
	option.
...
<div class="krumo-title">
	This is a list of all the values from the
	<code>
		<b><?php echo realpath($ini_file) ? realpath($ini_file) : $ini_file;?></b>
	</code>
	INI file.
</div>
<?php
...
<div class="krumo-root" dir="ltr">
    ...
    <li class="krumo-footnote">
			<div class="krumo-version" style="white-space: nowrap;">
				<h6>Krumo version <?php echo krumo::version();?></h6>
				| <a href="http://krumo.sourceforge.net" target="_blank">http://krumo.sourceforge.net</a>
			</div>

    <?php if (@$d['file']) { ?>
    <span class="krumo-call" style="white-space: nowrap;"> Called from <code><?php echo $d['file']?></code>,
